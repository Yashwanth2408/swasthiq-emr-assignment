...
import { CREATE_APPOINTMENT, GET_APPOINTMENTS } from "@/lib/graphql/operations";
                    ...
                    <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 px-8 py-8 text-white">
                        <div className="flex items-center gap-4 mb-3">
                            ...
                            <div>
                                ...
                                <p className="text-indigo-100 text-sm mt-1">Fill in the details below to schedule an appointment</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-8">
                        {error && (
                            ...
                            >
                                ...
                                <div>
                                    <p className="text-red-900 font-semibold">Error creating appointment</p>
